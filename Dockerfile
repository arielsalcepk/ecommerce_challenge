...
#     E.g.: docker.io/hexpm/elixir:1.20.2-erlang-28.4.3-debian-trixie-20260713-slim
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/ecommerce_challenge ./
